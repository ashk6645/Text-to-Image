...
//                     <img src={assets.profile_icon} alt="" className='w-10 h-10 rounded-full' />
...
//                     <img src={assets.email_icon} alt="" className='w-10 h-10 rounded-full' />
...
//                 <div className='border px-6 py-2 flex items-center gap-2 rounded-full mt-4'>
//                     <img src={assets.lock_icon} alt="" className='w-10 h-10 rounded-full' />
